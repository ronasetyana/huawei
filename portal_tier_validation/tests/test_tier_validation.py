...
class TestportalTierValidation(common.SavepointCase):
    @classmethod
    def setUpClass(cls):
        super(TestportalTierValidation, cls).setUpClass()
    ...
    def tearDownClass(cls):
        ...
        super(TestportalTierValidation, cls).tearDownClass()
    ...
    def test_01_tier_definition_models(self):
        ...
        self.assertIn("portal.order", res)

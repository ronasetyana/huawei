...
========================
portal Tier Validation
========================

This module extends the functionality of portal Orders to support a tier
validation process.
...
#. Create as many tiers as you want for portal Order model.
...
#. Create a portal Order triggering at least one "Tier Definition".
...
<https://github.com/OCA/portal-workflow/issues>`_. In case of trouble, please
